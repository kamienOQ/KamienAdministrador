...
import { onChangeSavingNewAttribute, onAddImage, onAddIcon, onAddSuccessMessage, onAddErrorMessage, 
    onCleanAttributes, onAddAttributeAtStart, onSetAttributes, onSetNumberAttributes, onUpdateAttribute,onAddAttributeNameLowerCase, onChangeActive, onSetCategoriesRelated,onSetExamplesRelated} from ".";
...
export const onStartUploadNewAttribute = () => {
  return async (dispatch, getState) => {
    ...
    const {examplesSelected} = getState().ui;
    dispatch(onSetExamplesRelated(examplesSelected));
